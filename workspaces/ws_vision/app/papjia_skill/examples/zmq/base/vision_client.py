...
示例命令:
  ...
  python vision_client.py --test detection --image_topic /camera/rgb/image_raw --service_name /my_detection_service
    ...
    parser.add_argument(
        "--image_topic",
        type=str,
        default="/right_camera/color/image_raw",
        help="图像话题名称",
    )
    parser.add_argument(
        "--detection_service_name",
        type=str,
        default="/vision/detection_mask_cub",
        help="检测服务名称",
    )
    parser.add_argument(
        "--score",
    ...
    parser.add_argument(
        "--depth_topic_name",
        type=str,
        default="/right_camera/aligned_depth_to_color/image_raw",
        help="深度图像话题名称",
    )
    parser.add_argument(
        "--camera_info_topic_name",
        type=str,
        default="/right_camera/color/camera_info",
        help="相机信息话题名称",
    )
    parser.add_argument(
        "--mask_service_name",
    ...
    parser.add_argument(
        "--target_frame",
        type=str,
        default="right_camera_workspace",
        help="目标坐标系名称",
    )
    parser.add_argument(
        "--obb_service_name",
