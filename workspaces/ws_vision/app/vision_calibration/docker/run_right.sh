...
ros2 launch charuco_detector charuco_detector.launch.py \
  ...
  ros_param_file:='/home/yw/workspace/config/charuco/ros_right.yaml' \
...
python3 -m vision_calibration.rest_api --config '/home/yw/workspace/config/vision_calibration/config_right.yaml' \
