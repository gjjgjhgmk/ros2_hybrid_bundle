...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="0x09",
            description="Gripper slave address (Modbus RTU slave ID) in hexadecimal format (e.g., 0x02).",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    # Include control.launch.py with left_arm configuration
    ...
    return LaunchDescription(
        declared_arguments + [left_arm_launch]
    )
